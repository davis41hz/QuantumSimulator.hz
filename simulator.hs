...
divideComplex (Complex r1 i1) (Complex 0 0) = error "Division by zero"
divideComplex (Complex r1 i1) (Complex r2 i2) =
    let denominator = r2^2 + i2^2
...
modulusComplex (Complex r i) = sqrt(r^2 + i^2)
